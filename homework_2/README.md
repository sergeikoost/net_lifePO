...
Переходим в настройку сборки, general settings и прописываем в  разделе Artifact paths строчку:

```
target/*.jar => artifact.jar

```
18) Проведите повторную сборку мастера, убедитесь, что сбора прошла успешно и артефакты собраны.
  
<img width="1524" height="482" alt="ci cd_homework1 10" src="https://github.com/user-attachments/assets/543e128f-0c94-447c-9961-5b67cf52db6c" />

Теперь все собирается в .jar файлы.
